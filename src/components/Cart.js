...
const Cart = () => {
  return (
    <div className="max-w-container mx-auto px-4">
          ...
          <div>
            <div className="w-full grid grid-cols-5 mb-4 border py-2">
              <div className="flex col-span-5 md:col-span-2 items-center gap-4 ml-4">
                <ImCross className="text-[#262626] hover:text-red-500 duration-300 cursor-pointer" />
                <img
                  className="w-32 h-32"
                  src="https://orebishopping.reactbd.com/static/media/newArrTwo.bdc7d9372116bdf40cc4.webp"
                  alt="productImage"
                />
      ...
      >
        <div>
          <img className="w-80 rounded-lg p-4 mx-auto" src="" alt="emptyCart" />
        </div>
